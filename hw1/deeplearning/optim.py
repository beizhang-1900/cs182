...
def rmsprop(x, dx, config=None):
    ...
    #############################################################################
    s = config['cache'] * config['decay_rate'] + (1 - config['decay_rate']) * dx ** 2
...
def adam(x, dx, config=None):
    ...
    #############################################################################  
    m_next = (1 - config['beta1']) * dx + config['beta1'] * config['m']
    v_next = (1 - config['beta2']) * dx **2 +config['beta2'] * config['v']
    m_hat = m_next / (1 - config['beta1'] ** (config['t'] + 1))
    v_hat = v_next / (1 - config['beta2'] ** (config['t'] + 1))
